import { Tent, BedDouble, Backpack, Shirt, Utensils, Apple, Smartphone, Stethoscope, Compass, Pickaxe, Droplet, Sparkles } from "lucide-react";
...
export const getCategoryIcon = (category: string) => {
  switch (category) {
    ...
    case "Hydratation": return <Droplet size={14} className="text-[var(--text-muted)]" />;
    ...
    case "Hygiène": return <Sparkles size={14} className="text-[var(--text-muted)]" />;
    case "Secours": return <Stethoscope size={14} className="text-[var(--text-muted)]" />;
