...
export function ItemModal({ isOpen, onClose, onSave, initialData }: ItemModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in">
      <div className="bg-[var(--surface-color)] rounded-3xl w-full max-w-lg shadow-2xl border border-[var(--border-color)] overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto flex flex-col gap-5 flex-grow">
        ...
        <div className="border-t border-[var(--border-color)] p-6 bg-[var(--surface-color)] shrink-0">
          <button 
